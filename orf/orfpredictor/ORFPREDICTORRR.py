...
def main( XMLfile, CAP3, threshold ):
    ...
    os.system("./orf/orfpredictor/orf_prediction_part1.py -b "+str(XMLfile)+" -f "+str(CAP3) )
    #print "BLASTelongator has finished. Starting 2nd part..."
    # It has written to temp and now comes Ina's script
    if os.path.isfile(OUTFILEPART2) == 1:
        os.system("./orf/orfpredictor/orf_prediction_part2.py"+" -t "+str(threshold)+" -f " + OUTFILEPART2 )
